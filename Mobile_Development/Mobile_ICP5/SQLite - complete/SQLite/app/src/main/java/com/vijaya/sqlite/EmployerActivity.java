...
public class EmployerActivity extends AppCompatActivity {
    ...
    private void deleteFromDataBase(){
        ...
        String selection =
                SampleDBContract.Employer.COLUMN_NAME +" like ? and " + SampleDBContract.Employer.COLUMN_DESCRIPTION+" like ?";
...
//        String ID = cursor.getString(cursor.getColumnIndexOrThrow(SampleDBContract.Employer._ID));
        ...
        if(cursor.getCount()>0){
            ...
            String ID = cursor.getString(cursor.getColumnIndexOrThrow(SampleDBContract.Employer._ID));
            db.delete(SampleDBContract.Employer.TABLE_NAME + " where ",SampleDBContract.Employer._ID + "=?", new String[]{ID}); //new String[]{ID}
        }
